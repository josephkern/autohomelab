...
| 7 | unsloth/Qwen3.6-27B-NVFP4 | 27B dense mm · NVFP4 | mtp-n1 (MTP) | 16.8 | **161.5** | — | 84.3 | 98.0 | 71.6 |
| 8 | RedHatAI/gemma-4-31B-it-NVFP4 | 31B dense mm · NVFP4 | baseline | 10.5 | **109.0** | 136.7 | 41.2 ✗ | 73.0 | 48.4 |
| 9 | RedHatAI/NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4 | 120B/12B MoE · NVFP4 | mtp-n1 (MTP) | 22.4 | **93.7** | 120.5 | 85.8 | 61.0 | 75.0 |
...
- **MTP is the dominant throughput lever** where the head survives quantization: **Qwen3.6-27B +31.7%
  ...
  Qwen3-Next-80B Instruct +12.4% / Thinking +14.9%. Qwen3.6-35B keeps MTP on in its baseline (mtp-off
  −14.5%). Qwen3-Coder-Next's NVFP4 build **stripped** the MTP head, so no lever — it sits below its
  Instruct sibling despite identical arch. (qwen3_5_mtp loads on stock 0.23.0; qwen3_next_mtp needed patches.)
