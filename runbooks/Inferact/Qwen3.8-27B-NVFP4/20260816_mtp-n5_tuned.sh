#!/usr/bin/env bash
# TUNED VARIANT (mtp-n5) — base: runbooks/Inferact/Qwen3.8-27B-NVFP4/baseline.sh
# Deltas vs base: ADD --speculative-config '{"method":"mtp","num_speculative_tokens":5}'
...
#   (predicts 1.74 and 2.70 vs measured 1.766 and 2.675), and extrapolates acc_len ~3.21 at n=5.
#   If throughput tracks accepted length, n=5 should beat n=3's c16=167.66. Risk: each extra draft
