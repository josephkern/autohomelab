#!/usr/bin/env bash
# FINAL (campaign-selected) — promoted from runbooks/Inferact/Qwen3.8-27B-NVFP4/20260816_mtp-n3_tuned.sh on 2026-08-18.
# Result: MTP n=3: chat c16 116.63->171.12 (+46.7%), c1 10.34->17.15 (+65.9%); all three gates green on vLLM 0.27.1 (gsm8k FULL 95.45, mmlu_pro FULL 66.81)
