...
# Hypothesis: model ships native shared-weight MTP layers; verified-lossless spec decode raises decode
#   tok/s on a bandwidth-bound model (helped the 35B MoE +14% at c16). Risk: MTP+hybrid-Mamba may serve_fail.
