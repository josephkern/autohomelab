#!/usr/bin/env bash
# TUNED VARIANT (batched-16k) on vLLM 0.23.0 — base: runbooks/RedHatAI/gemma-4-31B-it-NVFP4/baseline.sh
# Deltas vs base: + --max-num-batched-tokens 16384
# Hypothesis: Larger chunked-prefill budget co-schedules more prefill with decode at c16/c32 (V1 default is small here, raised to 2496 for video).
