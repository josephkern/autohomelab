#!/usr/bin/env bash
# TUNED VARIANT (batched-32k-util08) on vLLM 0.23.0 — base: runbooks/RedHatAI/Qwen3.6-35B-A3B-NVFP4/baseline.sh
# Deltas vs base: --max-num-batched-tokens 16384 -> 32768 WITH --gpu-memory-utilization 0.8
# Hypothesis: Larger chunked-prefill budget co-schedules more prefill with decode; needs the 0.8 headroom. Probes whether 16384 was the knee.
