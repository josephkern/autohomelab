#!/usr/bin/env bash
# TUNED VARIANT (kv-nvfp4) — base: runbooks/RedHatAI/Qwen3.6-35B-A3B-NVFP4/20260704_v0.24.0_baseline.sh
# Deltas vs base: --kv-cache-dtype fp8_e4m3 -> nvfp4
# Hypothesis: nvfp4 KV halves cache footprint vs fp8 -> more room for batched KV at c16/c32 on the
#   bandwidth-bound unified pool. Numeric-risky (KV dtype) -> eval mmlu; watch for c16 wedge.
