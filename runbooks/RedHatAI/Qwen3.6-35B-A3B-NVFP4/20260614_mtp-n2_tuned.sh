#!/usr/bin/env bash
# TUNED VARIANT (mtp-n2) on vLLM 0.23.0 — base: runbooks/RedHatAI/Qwen3.6-35B-A3B-NVFP4/baseline.sh
# Deltas vs base: --speculative-config num_speculative_tokens 1 -> 2
# Hypothesis: More draft tokens per step can improve acceptance-amortized throughput if accept rate is high. Lossless.
