#!/usr/bin/env bash
# TUNED VARIANT (moe-marlin) on vLLM 0.23.0 — base: runbooks/RedHatAI/Qwen3.6-35B-A3B-NVFP4/baseline.sh
# Deltas vs base: --moe-backend flashinfer_cutlass -> marlin
# Hypothesis: marlin is the conservative NVFP4 MoE kernel; baseline candidate from the queue. Numeric-risky -> eval mmlu.
