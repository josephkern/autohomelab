#!/usr/bin/env bash
# TUNED VARIANT (linear-b12x) — base: runbooks/RedHatAI/Qwen3.6-35B-A3B-NVFP4/20260704_v0.24.0_baseline.sh
# Deltas vs base: ADD --linear-backend flashinfer_b12x (NEW choice in 0.24; absent from 0.23's list)
# Hypothesis: 0.24 exposes flashinfer b12x on the linear/dense GEMM path — the FP4 GEMM the charter
#   flagged for SM120/121. May beat the default linear kernel. Numeric-risky (GEMM path) -> eval mmlu.
