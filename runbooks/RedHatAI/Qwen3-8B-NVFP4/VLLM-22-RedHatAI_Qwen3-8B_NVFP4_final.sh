#!/usr/bin/env bash
# FINAL (campaign-selected) — promoted from runbooks/RedHatAI/Qwen3-8B-NVFP4/20260613_native-fp4_tuned.sh on 2026-06-13.
# Result: best config = native NVFP4 W4A4 (no --linear-backend marlin). vs Marlin baseline:
#   chat c16 median 491.8 tok/s (n=4) vs 466.8 (+5.4%); c32 745.7 vs 687.7 (+8.4%).
#   full curve @180s/seed42: c1=38.8 c4=149.3 c8=277.1 c16=486.7 c32=745.7. sm_121 stable. vLLM v0.22.0.
