#!/usr/bin/env bash
# FINAL (campaign-selected) — promoted from runbooks/RedHatAI/Qwen3-8B-NVFP4/baseline.sh on 2026-06-13.
# Result: 0.23.0 native NVFP4 W4A4 + reasoning-parser qwen3. ALL GATES PASS: smoke 3/3; gsm8k=91.0 mmlu=73.61 (>=0.22.0); chat c16=497 c32=770.8 (+2-3% vs 0.22.0). vLLM v0.23.0 (img 6d8429e).
