#!/usr/bin/env bash
# TUNED VARIANT (b12x) on vLLM 0.23.0 — base: runbooks/RedHatAI/Qwen3-8B-NVFP4/baseline.sh
# Deltas vs base: + --linear-backend flashinfer_b12x + FLASHINFER env (0.23.0 b12x FP4 SM120/121)
...
VLLM_ENV=( "FLASHINFER_CUDA_ARCH_LIST=12.0f" "FLASHINFER_DISABLE_VERSION_CHECK=1" )
