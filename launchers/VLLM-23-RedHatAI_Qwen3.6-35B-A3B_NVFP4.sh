...
# AUTO-GENERATED by scripts/gen_launcher.sh from runbooks/RedHatAI/Qwen3.6-35B-A3B-NVFP4/VLLM-23-RedHatAI_Qwen3.6-35B-A3B_NVFP4_final.sh — do not hand-edit.
#
...
#   PORT=8001 NAME=foo ./VLLM-23-RedHatAI_Qwen3.6-35B-A3B_NVFP4.sh   # override the published port / container name
#
