...
# AUTO-GENERATED by scripts/gen_launcher.sh from runbooks/nvidia/Qwen3-Next-80B-A3B-Instruct-NVFP4/VLLM-23-nvidia_Qwen3-Next-80B-A3B-Instruct_NVFP4_final.sh — do not hand-edit.
#
...
#   PORT=8001 NAME=foo ./VLLM-23-nvidia_Qwen3-Next-80B-A3B-Instruct_NVFP4.sh   # override the published port / container name
#
